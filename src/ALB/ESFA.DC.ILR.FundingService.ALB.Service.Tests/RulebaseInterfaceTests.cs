    ...
    public class RulebaseInterfaceTests
    {
        ...
        public IList<string> ExpectedAttributes()
        {
            return new List<string>
            {
                ...
                "SubsidyPilotEffectiveFrom",
                "SubsidyPilotEffectiveTo",
                "LARSFundCategory",
                "LARSFundEffectiveFrom",
                "LARSFundEffectiveTo",
                "LARSFundWeightedRate",
                "LARSFundWeightingFactor",
                "LearnDelLARSCarPilFundAreaCode",
                "LearnDelLARSCarPilFundEffToDate",
                "LearnDelLARSCarPilFundEffFromDate",
                "LearnDelLARSCarPilFundSubsidyRate"
            };
        }
