...
{
    public class ALBActorDtoProviderTests
    {
        [Fact]
        public void Provide()
        {
            ...
            learnerPagingServiceMock.Setup(lpm => lpm.ProvideDtos(99, message)).Returns(learnerPagingReturn);
        ...
        private ALBActorDtoProvider NewProvider(ILearnerPagingService<ALBLearnerDto> learnerPagingService = null, IJsonSerializationService jsonSerializationService = null)
        {
            return new ALBActorDtoProvider(learnerPagingService, jsonSerializationService);
        }
    }
}
