...
namespace ESFA.DC.ILR.FundingService.FM25Actor
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of FM25Actor
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IFM25Actor.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IFM25Actor.SetCountAsync(int count, CancellationToken cancellationToken)
        {
