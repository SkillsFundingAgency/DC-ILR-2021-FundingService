...
namespace ESFA.DC.ILR.FundingService.FM70.Service.Tests
{
    public class FundingOutputServiceTests
    {
        ...
        public void LearningDeliveryFromDataEntity()
        {
            ...
            var adjustedStartDate = new DateTime(2019, 8, 1);
            ...
            var eligibleProgressionOutomeStartDate = new DateTime(2019, 8, 1);
            var fundStart = true;
            var lARSWeightedRate = 5.0m;
            var latestPossibleStartDate = new DateTime(2019, 8, 1);
            var lDESFEngagementStartDate = new DateTime(2019, 8, 1);
            var learnDelLearnerEmpAtStart = true;
            var potentiallyEligibleForProgression = true;
            var progressionEndDate = new DateTime(2019, 8, 1);
            var restart = true;
        ...
        public void LearningDeliveryDeliverablePeriodisedValues_WithChangePoints_Correct()
        {
            ...
            var learningDeliveryDeliverablePeriodisedValues =
                NewService(dataEntityAttributeServiceMock.Object).LearningDeliveryDeliverablePeriodisedValuesFromEntity(TestLearningDeliveryEntityWithChangePoints(null).Single());
