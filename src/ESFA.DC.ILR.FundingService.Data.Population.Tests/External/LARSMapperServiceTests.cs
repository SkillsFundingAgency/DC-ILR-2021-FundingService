        ...
        public void MapLARSLearningDeliveries()
        {
            ...
            {
                {
                    ...
                    new Data.External.LARS.Model.LARSLearningDelivery
                    {
                        ...
                        LARSCareerLearningPilots = new List<Data.External.LARS.Model.LARSCareerLearningPilot>
                        {
                            new Data.External.LARS.Model.LARSCareerLearningPilot
                            {
                                AreaCode = "AreaCode",
                                SubsidyRate = 1.0m,
                                EffectiveFrom = new DateTime(2018, 8, 1),
                ...
                },
                {
                    ...
                    new Data.External.LARS.Model.LARSLearningDelivery
                    {
                        ...
                        LARSFrameworkAims = new List<Data.External.LARS.Model.LARSFrameworkAim>
                        {
                            new Data.External.LARS.Model.LARSFrameworkAim
                            {
                                FworkCode = 1,
                                ProgType = 1,
                                PwayCode = 1,
            ...
            var larsLearningDeliveries = new List<ReferenceDataService.Model.LARS.LARSLearningDelivery>
            {
                ...
                new ReferenceDataService.Model.LARS.LARSLearningDelivery
                {
                    ...
                    LARSFrameworkAims = new List<ReferenceDataService.Model.LARS.LARSFrameworkAim>
                    {
                        new ReferenceDataService.Model.LARS.LARSFrameworkAim
                        {
                            FworkCode = 1,
                            ProgType = 1,
                            PwayCode = 1,
