...
{
    public class FM35DtoProviderTests
    {
        [Fact]
        public void Provide()
        {
        ...
        private FM35DtoProvider NewProvider(ILearnerPagingService<FM35LearnerDto> learnerPagingService = null, IJsonSerializationService jsonSerializationService = null)
        {
            return new FM35DtoProvider(learnerPagingService, jsonSerializationService);
        }
    }
}
